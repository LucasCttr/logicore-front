...
export default function DriverDashboard({ shipmentCount = 0, vehicleAssigned = false }: DriverDashboardProps) {
    ...
    <div className="p-6 space-y-6">
      ...
      {vehicleAssigned && (
        <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
          ...
          <p className="text-lg text-gray-800 mt-2 font-semibold">✓ You have a vehicle assigned</p>
